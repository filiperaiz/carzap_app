...
// Pesquisar
.controller('PesquisarCtrl', function($scope, $stateParams, $ionicPopup) {
...
// Novo Anúncio
.controller('NovoAnuncioCtrl', function($scope, $stateParams, $ionicPopup, $ionicModal, $cordovaCamera) {
...
// Lista de Anúncios
.controller('ListCarsCtrl', function($scope, $stateParams) {
...
// Editar Perfil
.controller('EditarPerfilCtrl', function($scope, $ionicPopup) {
...
// Anúncio
.controller('AnuncioCtrl', function($scope, $stateParams, $ionicActionSheet, $ionicModal, $timeout) {
...
// Meus Anúncios
.controller('MeusAnunciosListCtrl', function($scope, $state, $stateParams, $ionicModal) {
